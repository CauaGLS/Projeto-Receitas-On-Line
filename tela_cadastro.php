...
<head>
    ...
    <title>Receitas On-Line | Registre-se</title>
...
<body>
    ...
    <!-- Área de Cadastro COMEÇO -->
    <section class="contact-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <form action="php/dbregistra_cadastro.php" method="post" class="contact-form">
                        <h3>Cadastre-se</h3>
                        <div class="row">
                            <div class="col-lg-6">
                    ...
                    <a href="tela_login.php">Já Possuo Cadastro</a>
                </div>
            </div>
        </div>
    </section>
