...
<?php
    ...
    //Busca dados da receita com base no ID
    $query = "SELECT * FROM Receitas WHERE ID_receita = '$id'";
    $result = mysqli_query($conexao, $query);
    $row = mysqli_fetch_assoc($result);

    //Busca imagens com base no ID da receita
    $query2 = "SELECT * FROM Imagens WHERE ID_fk_receita = '$id'";
    $result2 = mysqli_query($conexao, $query2);
    $row2 = mysqli_fetch_assoc($result2);

        //Preenche os campos do formulário com os dados já existentes
...
<head>
    ...
    <title>Receitas On-Line | Alterar Receita</title>
            ...
            <div class="col-lg-12">
                <div class="blog-text">
                    <div class="blog-title">
                        <h2>Altere sua Receita </h2>
                        <span>Preencha os Campos*</span>
                    </div>
                    <form action="php/dbatualizar_receita.php" method="post" enctype="multipart/form-data" class="comment-form">
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <input type="text" id="nome" name="nome" placeholder="Nome da Receita" value="<?php echo $nome; ?>">
                            </div>
                            <div class="col-lg-4">
                                <input type="text" id="tipo" name="tipo" placeholder="Tipo de Culinária" value="<?php echo $tipo; ?>">
                            </div>
                            <div class="col-lg-12">
                                <textarea id="descricao" name="descricao" placeholder="Descreva brevemente sua receita" style="height: 100px"><?php echo $descricao; ?></textarea>
                            </div>
                            <div class="col-lg-4">
                                <textarea id="ingredientes" name="ingredientes" placeholder="Ingredientes"><?php echo $ingredientes; ?></textarea>
                            </div>
                            <div class="col-lg-8">
                                <textarea id="tutorial" name="tutorial" placeholder="Tutorial"><?php echo $tutorial; ?></textarea>
                            </div>
                            <div class="col-lg-12">
                                <input type="text" id="notas" name="notas" placeholder="Notas(Opcional)" value="<?php echo $notas; ?>">
                            </div>
                            <div class="col-lg-12">
